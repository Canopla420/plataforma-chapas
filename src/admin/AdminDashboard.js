        ...
        <div class="admin-sidebar">
          ...
          <nav class="admin-nav">
            <div class="admin-nav-item">
              <a href="/admin/dashboard" class="admin-nav-link active" data-navigate>
                📊 Dashboard
              </a>
            </div>
            <div class="admin-nav-item">
              <a href="/admin/pedidos" class="admin-nav-link" data-navigate>
                📦 Pedidos (${this.stats.pendingOrders})
              </a>
            </div>
            <div class="admin-nav-item">
              <a href="/admin/productos" class="admin-nav-link" data-navigate>
                🏗️ Productos
              </a>
            </div>
            <div class="admin-nav-item">
